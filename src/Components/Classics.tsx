    ...
    >
      ...
      >
        ...
        <h2 className="section-title text-white mb-4">
          Super <span className="text-neon-gold neon-text">Clásicos</span>
        </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto">
        {videos.map(({ id, title }, index) => (
          <motion.div
            ...
            className="glass-card overflow-hidden group hover:border-neon-gold/40 transition-all duration-300"
            style={{ boxShadow: '0 4px 30px rgba(0,0,0,0.5)' }}
          >
            {/* Card header */}
            <div className="px-4 pt-4 pb-3 flex items-center gap-2 border-b border-white/5">
              <span className="w-2 h-2 rounded-full bg-neon-gold animate-pulse flex-shrink-0" />
